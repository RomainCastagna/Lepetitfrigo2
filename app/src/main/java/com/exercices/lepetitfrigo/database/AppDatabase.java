...
import com.exercices.lepetitfrigo.database.dao.CategorieDao;
import com.exercices.lepetitfrigo.database.dao.ProduitDao;
...
@Database(entities = {ProduitEntity.class, CategorieEntity.class}, version = 1)
    ...
    public static void initializeDemoData(final AppDatabase database) {
        Executors.newSingleThreadExecutor().execute(() -> {
            database.runInTransaction(() -> {
                ...
                database.categorieDao().deleteAll();
                database.produitDao().deleteAll();
